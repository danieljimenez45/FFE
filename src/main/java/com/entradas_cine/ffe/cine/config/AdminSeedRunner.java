    ...
    private List<Pelicula> seedPeliculas() {
        ...
        List<Pelicula> peliculas = peliculaRepository.saveAll(List.of(
            pelicula("Toy Story",
                     ...
                     81, "John Lasseter", "2026-04-03", ClasificacionEdad.TP, true, "/images/peliculas/toystory.jpg"),

            pelicula("El Rey León",
                     Genero.AVENTURAS,
                     "Un joven león debe asumir su destino como rey.",
                     88, "Roger Allers", "2026-04-07", ClasificacionEdad.TP, false, "/images/peliculas/reyleon.jpg"),

            pelicula("Regreso al Futuro",
                     Genero.CIENCIA_FICCION,
                     "Un adolescente viaja accidentalmente al pasado.",
                     116, "Robert Zemeckis", "2026-04-10", ClasificacionEdad.TP, true, "/images/peliculas/regresoalfuturo.jpg"),

            pelicula("Forrest Gump",
                     Genero.DRAMA,
                     "La extraordinaria vida de un hombre sencillo.",
                     142, "Robert Zemeckis", "2026-04-12", ClasificacionEdad.MAYORES_7, true, "/images/peliculas/forrestgump.jpg"),

            pelicula("La La Land",
                     Genero.ROMANCE,
                     "Una historia de amor entre música y cine.",
                     128, "Damien Chazelle", "2026-04-15", ClasificacionEdad.MAYORES_7, true, "/images/peliculas/lalaland.jpg"),

            pelicula("Inception",
                     Genero.CIENCIA_FICCION,
                     "Un ladrón roba secretos a través de los sueños.",
                     148, "Christopher Nolan", "2026-04-18", ClasificacionEdad.MAYORES_12, true, "/images/peliculas/inception.jpg"),

            pelicula("Interstellar",
                     Genero.CIENCIA_FICCION,
                     "Exploradores viajan a través de un agujero de gusano.",
                     169, "Christopher Nolan", "2026-04-21", ClasificacionEdad.MAYORES_12, false, "/images/peliculas/interstellar.jpg"),

            pelicula("El Señor de los Anillos: La Comunidad del Anillo",
                     Genero.FANTASIA,
                     "Un hobbit inicia un viaje para destruir un anillo.",
                     178, "Peter Jackson", "2026-04-23", ClasificacionEdad.MAYORES_12, true, "/images/peliculas/lotr.jpg"),

            pelicula("Jurassic Park",
                     Genero.CIENCIA_FICCION,
                     "Dinosaurios clonados escapan de control.",
                     127, "Steven Spielberg", "2026-04-25", ClasificacionEdad.MAYORES_12, false, "/images/peliculas/jurassicpark.jpg"),

            pelicula("Gladiator",
                     Genero.ACCION,
                     "Un general romano busca venganza.",
                     155, "Ridley Scott", "2026-04-02", ClasificacionEdad.MAYORES_16, true, "/images/peliculas/gladiator.jpg"),

            pelicula("Matrix",
                     Genero.CIENCIA_FICCION,
                     "Un hacker descubre la verdad sobre su realidad.",
                     136, "Lana Wachowski", "2026-04-05", ClasificacionEdad.MAYORES_16, false, "/images/peliculas/matrix.jpg"),

            pelicula("Alien",
                     Genero.TERROR,
                     "Una criatura mortal acecha a una tripulación espacial.",
                     117, "Ridley Scott", "2026-04-08", ClasificacionEdad.MAYORES_16, true, "/images/peliculas/alien.jpg"),

            pelicula("El Sexto Sentido",
                     Genero.SUSPENSE,
                     "Un niño afirma ver personas muertas.",
                     107, "M. Night Shyamalan", "2026-04-11", ClasificacionEdad.MAYORES_16, true, "/images/peliculas/sextosentido.jpg"),

            pelicula("Pulp Fiction",
                     Genero.DRAMA,
                     "Historias entrelazadas del crimen en Los Ángeles.",
                     154, "Quentin Tarantino", "2026-04-14", ClasificacionEdad.MAYORES_18, true, "/images/peliculas/pulpfiction.jpg"),

            pelicula("El Lobo de Wall Street",
                     Genero.DRAMA,
                     "El ascenso y caída de un corredor de bolsa.",
                     180, "Martin Scorsese", "2026-04-17", ClasificacionEdad.MAYORES_18, false, "/images/peliculas/lobowallstreet.jpg"),

            pelicula("Joker",
                     Genero.DRAMA,
                     "El origen oscuro de un villano.",
                     122, "Todd Phillips", "2026-04-20", ClasificacionEdad.MAYORES_18, true, "/images/peliculas/joker.jpg"),

            pelicula("La Máscara",
                     Genero.COMEDIA,
                     "Un hombre descubre una máscara con poderes.",
                     101, "Chuck Russell", "2026-04-22", ClasificacionEdad.MAYORES_7, true, "/images/peliculas/lamascara.jpg"),

            pelicula("Resacón en Las Vegas",
                     Genero.COMEDIA,
                     "Una despedida de soltero se sale de control.",
                     100, "Todd Phillips", "2026-04-26", ClasificacionEdad.MAYORES_16, true, "/images/peliculas/resacon.jpg"),

            pelicula("Ocho Apellidos Vascos",
                     Genero.COMEDIA,
                     "Un andaluz viaja al País Vasco por amor.",
                     98, "Emilio Martínez-Lázaro", "2026-04-28", ClasificacionEdad.MAYORES_7, true, "/images/peliculas/ochoapellidosvascos.jpg"),

            pelicula("Seven",
                     Genero.SUSPENSE,
                     "Un asesino en serie basado en los pecados capitales.",
                     127, "David Fincher", "2026-04-30", ClasificacionEdad.MAYORES_18, true, "/images/peliculas/seven.jpg")
        ));
